...
public class Ks3Client implements Ks3 {
	...
	public PutObjectResult PutObject(String bucketname, String objectkey,
			...
			throws Ks3ClientException, Ks3ServiceException {
		return putObject(new PutObjectRequest(bucketname,objectkey,inputstream,objectmeta));
	}
	...
	public CompleteMultipartUploadResult completeMultipartUpload(
			...
			Ks3ServiceException {
		return completeMultipartUpload(new CompleteMultipartUploadRequest(bucketname,objectkey,uploadId,partETags));
	}
